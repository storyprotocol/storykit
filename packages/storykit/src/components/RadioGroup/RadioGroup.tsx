...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ref={ref}
      className={cn(
        "sk-h-4 sk-w-4 sk-rounded-full sk-border sk-border-gray-200 sk-text-primary sk-ring-offset-background sk-transition-all focus:sk-outline-none focus-visible:sk-ring-2 focus-visible:sk-ring-gray-400 focus-visible:sk-ring-offset-2 disabled:sk-cursor-not-allowed disabled:sk-opacity-50 dark:sk-border-gray-800",
        className
      )}
      {...props}
    >
      <RadioGroupPrimitive.Indicator className="sk-flex sk-items-center sk-justify-center">
        <Circle className="sk-h-2.5 sk-w-2.5 sk-fill-current" />
