...
- **ipLicenseTermsData** - Licenses attached to the IP Asset.
- **isIpLicenseTermsDataLoading** - IPA License Terms data loading state.
- **licenseTermsData** - The License Terams details including the id, template address and list of license terms.
- **isPolicyDataLoading** - License Terms data loading state.
