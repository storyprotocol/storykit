...
- **chain** - the Story Chain config as defined in [chains.ts](https://github.com/storyprotocol/storykit/blob/main/packages/storykit/src/lib/chains.ts)
...
- **defaultCurrency** - The default currency as defined in [currencies.ts](https://github.com/storyprotocol/storykit/blob/main/packages/storykit/src/lib/currencies.ts), sUSD if none provided
